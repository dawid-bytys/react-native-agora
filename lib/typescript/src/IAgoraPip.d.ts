 ...
 * ```
 */
export declare class AgoraPipContentViewLayout {
    /**
 ...
 */
export declare class AgoraPipOptions {
    /**
...
export declare enum AgoraPipState {
 ...
 */
export declare abstract class AgoraPip {
...
//# sourceMappingURL=IAgoraPip.d.ts.map